                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <input id="country_code"
                               ...
                               maxlength="3"
                               placeholder="US"
                               class="block flex-1 rounded-xl border bg-white px-3.5 py-2.5 font-mono text-sm uppercase text-gray-900 shadow-sm transition-colors placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 dark:bg-gray-900 dark:text-white dark:placeholder-gray-500
                                      @error('country_code') border-red-500 focus:border-red-500 focus:ring-red-500/30
                                      @else border-gray-300 focus:border-indigo-500 dark:border-gray-600 dark:focus:border-indigo-400
                                      @enderror">

                        {{-- Live flag preview --}}
                        <div class="flex h-[42px] w-[60px] shrink-0 items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
                            <img id="flag-preview"
                                 src=""
                                 alt=""
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        (e.g. <code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-[11px] text-gray-700 dark:bg-gray-700 dark:text-gray-200">US</code>,
                        <code class="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-[11px] text-gray-700 dark:bg-gray-700 dark:text-gray-200">GB</code>)
                    </p>
