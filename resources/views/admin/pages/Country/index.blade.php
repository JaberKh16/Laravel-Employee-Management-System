...
@section('dashboard_content')
    ...
    <div class="mx-auto max-w-5xl">
        ...
        <div class="mb-6 flex flex-wrap items-center gap-3">
            <form action="{{ route('countries.index') }}" method="GET" class="flex flex-1 min-w-[260px] items-center gap-2">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900/40">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Country Code</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse ($countries as $country)
                            <tr class="group transition-colors hover:bg-indigo-50/40 dark:hover:bg-indigo-950/20">
                                ...
                                {{-- Country name with flag-style avatar --}}
                                ...
                                {{-- Country code as monospace chip --}}
                                <td class="whitespace-nowrap px-4 py-3.5">
...
@push('dashboard_script')
    <script>
        ...
        window.deleteData = function (id) {
            if (! confirm('Delete this country? This action cannot be undone.')) return;
            document.getElementById('delete-form-' + id).submit();
        };

        // NOTE: Original code called $('#userTable').DataTable() but this page
        // has no table with id="userTable" — it silently did nothing.
        // Also there is no id at all on the <table>.
        // Server-side pagination via $countries->links() handles everything.
    </script>
@endpush