        ...
        <header class="mb-6 flex flex-wrap items-end justify-between gap-4 border-b border-gray-200 pb-5 dark:border-gray-700">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Update details for
                    <span class="font-semibold text-gray-700 dark:text-gray-300">{{ $country->name }}</span>
                </p>
            </div>
            ...
            <div class="space-y-6 p-6">
                ...
                <div>
                    ...
                    <input id="country_code"
                           ...
                           class="block w-full rounded-xl border bg-white px-3.5 py-2.5 font-mono text-sm uppercase text-gray-900 shadow-sm transition-colors placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 dark:bg-gray-900 dark:text-white dark:placeholder-gray-500
